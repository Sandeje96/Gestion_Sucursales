...
from wtforms import StringField, IntegerField, DecimalField, SelectField, BooleanField, HiddenField
...
class ExpenseForm(FlaskForm):
    ...
    is_paid = BooleanField('Pagado', default=False)

    def validate_for_user(self, user):
        # Reglas de permisos:
        # - admin: todo ok
        # - sucursal: solo su sucursal y categorías habilitadas
